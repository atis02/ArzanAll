...
export const AddToWishlistBox = ({ product }) => {
  ...
  return (
    <Pressable
      onPress={handlePress}
      className="bg-white dark:bg-dark-accent rounded-xl items-center justify-center absolute right-1 top-1 active:opacity-70 h-8 w-8"
    >
      {isItemInWishlist ? (
        <Image
